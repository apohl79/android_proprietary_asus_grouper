...
\$(call inherit-product-if-exists, vendor/grouper/asus/\$(LOCAL_STEM))
\$(call inherit-product-if-exists, vendor/grouper/broadcom/\$(LOCAL_STEM))
\$(call inherit-product-if-exists, vendor/grouper/elan/\$(LOCAL_STEM))
\$(call inherit-product-if-exists, vendor/grouper/invensense/\$(LOCAL_STEM))
\$(call inherit-product-if-exists, vendor/grouper/nvidia/\$(LOCAL_STEM))
\$(call inherit-product-if-exists, vendor/grouper/nxp/\$(LOCAL_STEM))
\$(call inherit-product-if-exists, vendor/grouper/trusted_logic/\$(LOCAL_STEM))
\$(call inherit-product-if-exists, vendor/grouper/widevine/\$(LOCAL_STEM))

\$(call inherit-product-if-exists, vendor/grouper/unknown/\$(LOCAL_STEM))
...
-include vendor/grouper/asus/\$(LOCAL_STEM)
-include vendor/grouper/broadcom/\$(LOCAL_STEM)
-include vendor/grouper/elan/\$(LOCAL_STEM)
-include vendor/grouper/invensense/\$(LOCAL_STEM)
-include vendor/grouper/nvidia/\$(LOCAL_STEM)
-include vendor/grouper/nxp/\$(LOCAL_STEM)
-include vendor/grouper/trusted_logic/\$(LOCAL_STEM)
-include vendor/grouper/widevine/\$(LOCAL_STEM)

-include vendor/grouper/unknown/\$(LOCAL_STEM)
EOF
